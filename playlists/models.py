...
from src.djangoflix.db.recievers import publish_state_pre_save, unique_slugify_pre_save
...
class Playlist(models.Model):
    ...
    state = models.CharField(max_length=2, choice=PublishStateOptions.choices, default=PublishStateOptions.DRAFT)
    publis_timestamp = models.DateTimeField(auto_now_add=False, auto_now=False, blank=True, null=True)
...
class PlaylistItemQuerySet(models.QuerySet):
    def published(self):
        ...
        return self.filter(
            ...
            vide__state=PublishStateOptions.PUBLISH,
